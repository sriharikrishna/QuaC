...
int main(int argc,char **args){
  ...
  PetscOptionsGetReal(NULL,NULL,"-gam3",&gamma_1[3],NULL);
  ...
  PetscOptionsGetReal(NULL,NULL,"-dep3",&gamma_2[3],NULL);
  ...
  PetscOptionsGetReal(NULL,NULL,"-sigx3",&sigma_x[3],NULL);
  ...
  PetscOptionsGetReal(NULL,NULL,"-sigy3",&sigma_y[3],NULL);
  ...
  PetscOptionsGetReal(NULL,NULL,"-sigz3",&sigma_z[3],NULL);
  ...
  PetscOptionsGetReal(NULL,NULL,"-om3",&omega[3],NULL);
  ...
  printf("gam: %f %f %f %f\n",gamma_1[0],gamma_1[1],gamma_1[2],gamma_1[3]);
  printf("dep: %f %f %f %f\n",gamma_2[0],gamma_2[1],gamma_2[2],gamma_2[3]);
  printf("sigx: %f %f %f %f\n",sigma_x[0],sigma_x[1],sigma_x[2],sigma_x[3]);
  printf("sigy: %f %f %f %f\n",sigma_y[0],sigma_y[1],sigma_y[2],sigma_y[3]);
  ...
  create_circuit(&teleportation,8);
  ...
  gate_time_step = 1.0;
  add_gate_to_circuit(&teleportation,1*gate_time_step,U3,0,0,0,PETSC_PI);
  add_gate_to_circuit(&teleportation,2*gate_time_step,CNOT,0,1);
  add_gate_to_circuit(&teleportation,3*gate_time_step,CNOT,0,2);
  add_gate_to_circuit(&teleportation,4*gate_time_step,CNOT,1,3);

  add_gate_to_circuit(&teleportation,5*gate_time_step,U3,0,0,0,PETSC_PI);
  add_gate_to_circuit(&teleportation,5*gate_time_step,U3,1,0,0,PETSC_PI);
  add_gate_to_circuit(&teleportation,5*gate_time_step,U3,2,0,0,PETSC_PI);
  add_gate_to_circuit(&teleportation,5*gate_time_step,U3,3,0,0,PETSC_PI);
  ...
  //partial_trace_over(rho,rho_tmp,3,qubits[1],qubits[1],qubits[2]);
