...
int main(int argc,char **args){
  ...
  gate_time_step = 1.0;
  add_gate_to_circuit(&teleportation,1*gate_time_step,RX,0);
...
add_gate_to_circuit(&teleportation,11*gate_time_step,CNOT,3,2);
add_gate_to_circuit(&teleportation,12*gate_time_step,HADAMARD,3);
